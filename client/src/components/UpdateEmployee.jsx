...
const UpdateEmployee = () => {
  ...
  useEffect(() => {
    (async () => {
      ...
      setData({
        ...
        departmentId: singleEmployee?.department.id,
        roleId: singleEmployee?.role.id,
      });
      setSelectImage(singleEmployee?.img);
    })();
  }, [
    ...
    getSingleEmployeeRequest,
    id,
    singleEmployee?.department.id,
    singleEmployee?.role.id,
  ...
  let submitCreateEmployee = async () => {
    ...
    if (IsEmpty(firstName)) {
      ...
      let res = await updateEmployeeRequest(id, {
        firstName,
        lastName,
        email,
        phone,
